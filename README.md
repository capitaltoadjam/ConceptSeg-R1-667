...
[![Stars](https://img.shields.io/github/stars/yuanzhao-CVLAB/ConceptSeg-R1?style=flat-square)](https://github.com/capitaltoadjam/ConceptSeg-R1-667/stargazers)
...
```bash
git clone https://github.com/capitaltoadjam/ConceptSeg-R1-667.git
cd ConceptSeg-R1-667
python setup.py
```
...
<!-- Last updated: 2026-06-06 20:23:48 -->
